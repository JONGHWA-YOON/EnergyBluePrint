...
namespace YunuText
{
    ...
    static D3DX11INLINE std::wstring ToString(const JsonStructType& s)
    {
    ...
    template<typename JsonStructType>
    static D3DX11INLINE JsonStructType FromString(const std::wstring& s)
    {
        JsonStructType x;
