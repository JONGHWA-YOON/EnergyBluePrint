...
void render_object::Helper::DebugArrow::RenderToTexture()
{
    // 입력 배치 객체 셋팅
    ...
    {
        md3dDeviceContext->IASetVertexBuffers(0, 1, &mVB_Cylinder, &stride, &offset);
        md3dDeviceContext->IASetIndexBuffer(mIB_Cylinder, DXGI_FORMAT_R32_UINT, 0);
        ...
        activeTech->GetPassByIndex(p)->Apply(0, md3dDeviceContext);
        md3dDeviceContext->DrawIndexed(mConeIndexCount, mConeIndexOffset, mConeVertexOffset);
